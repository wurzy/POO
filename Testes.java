...
public class Testes
{
    public static void main(String[] args) {
      ...
      //  System.out.println(hist2.equals(hist1));
       ...
       Ator at = new Ator("ola@user.com","Fernando","ola123","69 street xD",bir);
       Ator at2 = new Ator("ssss@user.com","Leandro","2222","420 blazing abbath 69",bir);
       ...
       Veiculo opel = new Veiculo("69-69-69",2,2,3,5,hist1,class1,4,10);
      ...
      // Aluguer al4 = new Aluguer(2,"op","ssss","sdadaa",p1,p3,p2,401,21,332);
       ...
       hist1.add(al2);
       hist1.add(al3);
       Ator at = new Ator("ola@user.com","Fernando","ola123","69 street xD",LocalDate.of(1,1,1),hist1);
